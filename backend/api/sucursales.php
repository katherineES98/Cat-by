<?php
    ...
    switch($_SERVER['REQUEST_METHOD']){
        ...
        echo  $sucursal ->guardarSucursal($_GET['id']);
           
        break;
        case 'GET': //obtener
          if (isset($_GET['id'])){
            Sucursal:: obtenerSucursale($_GET['id']);
           
        }else{
            Sucursal:: obtenerSucursales($_GET['id'],$_GET['index']);
        ...
        case 'PUT':
            ...
            $sucursal->actualizarSucursal($_GET['id'],$_GET['index']);
